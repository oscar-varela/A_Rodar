...
<div class="bg-danger collapse" id="men">
        <a href="caliz"> <li class="list-group-item list-group-item-action">Inicio</li> </a>
        <a href="catalogo.html">  <li class="list-group-item list-group-item-action">Catalogo</li> </a>
         <a href="prom.html">  <li class="list-group-item list-group-item-action">Promociones</li> </a>
    </div>
    ...
    <div>
        <h1>Bienvenido!!</h1>
             <div class="row px-4 py-4">
               ...
               <a href="producto.html" class="col-3 col-md-4"> <img class="w-100" src="./imagen/bicicletaA.jpg"></a>
               <a href="producto.html" class="col-5 col-md-4"> <img class="w-100" src="./imagen/bicicletaA.jpg"></a>
               <a href="producto.html" class="col-3 col-md-4"> <img class="w-100" src="./imagen/bicicletaA.jpg"></a>
             ...
             <div class="row px-5 py-5">
                <a href="catalogo.html" class="col-12"> <button class="col-12">Catalogo</button> </a>
